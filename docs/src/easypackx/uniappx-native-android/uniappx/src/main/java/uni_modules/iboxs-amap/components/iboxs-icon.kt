...
open class GenUniModulesIboxsAmapComponentsIboxsIcon : VueComponent {
    ...
    override fun data(): Map<String, Any?> {
        return _uM("i18n" to xConfig.i18n as Tmui4xI18nTml, "icons" to default__13 as UTSJSONObject, "getSize" to computed<String>(fun(): String {
            var size: String
