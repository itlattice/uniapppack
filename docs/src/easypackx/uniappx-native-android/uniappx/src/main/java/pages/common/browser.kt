...
open class GenPagesCommonBrowser : BasePage {
    ...
    companion object {
        ...
        var setup: (__props: GenPagesCommonBrowser) -> Any? = fun(__props): Any? {
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenPagesCommonBrowser
            ...
            onLoad(fun(options){
                ...
                if (title != null) {
                    uni_setNavigationBarTitle(SetNavigationBarTitleOptions(title = title.toString()))
                }
            }
            )
            onReady(fun(){
            ...
            return fun(): Any? {
                ...
                return _cE("view", null, _uA(
                    _cV(_component_web_view, _uM("src" to unref(src), "id" to "web", "class" to "full", "progressColor" to "#1678fd", "style" to _nS(_uM("height" to (unref(pageHeight) + "px")))), null, 8, _uA(
                        "src",
                        "style"
                    ))
                ))
