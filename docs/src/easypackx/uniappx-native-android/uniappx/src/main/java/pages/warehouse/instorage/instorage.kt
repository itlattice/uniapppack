...
open class GenPagesWarehouseInstorageInstorage : BasePage {
    ...
    companion object {
        ...
        var setup: (__props: GenPagesWarehouseInstorageInstorage) -> Any? = fun(__props): Any? {
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenPagesWarehouseInstorageInstorage
            ...
            val getDate = fun(): UTSPromise<Unit> {
                return wrapUTSPromise(suspend {
                        var res = await(request.callapi("common/getdate", _uO("page" to "warehouse/instorage")))
                        dateList.value = res.data as UTSArray<String>
                })
            }
            val getList = fun(): UTSPromise<Unit> {
                return wrapUTSPromise(suspend w1@{
                        var res = await(request.callapi("warehouse/instorageorder", _uO("date" to dateList.value, "page" to page.value, "keywords" to keywords.value)))
                        if (res.code < 0) {
            ...
            val newOrder = fun(){
                common.goto("/pages/warehouse/instorage/addinstorage", "slide-in-bottom")
            }
            ...
            return fun(): Any? {
                ...
                val _component_x_instorage_order = resolveEasyComponent("x-instorage-order", GenComponentsXInstorageOrderClass)
                ...
                return _cE("view", null, _uA(
                    _cV(_component_x_viewtitle, _uM("title" to "入库单"), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                        return _uA(
                            _cE("view", _uM("class" to "handles display-flex"), _uA(
                                _cE("view", _uM("class" to "addbtn display-flex", "onClick" to newOrder), _uA(
                                    ...
                                    _cE("text", _uM("class" to "name color-white"), "商品入库")
                                ))
                            ))
                        )
                    }
                    ...
                    _cE("view", _uM("class" to "searchview background-white display-flex"), _uA(
                        ...
                        , "width" to 570, "placeholder" to "入库单号/备注"), null, 8, _uA(
                            "modelValue"
                        )),
                                                ...
                                                return _cV(_component_x_longpress, _uM("key" to index, "onLongpress" to longPress), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                                                    return _uA(
                                                        _cE("view", _uM("class" to "orderitem display-flex background-white"), _uA(
                                                            _cV(_component_x_instorage_order, _uM("width" to unref(orderWidth), "order" to item, "index" to index, "onErWeima" to erWeima), null, 8, _uA(
                                                                "width",
                                                                "order",
                                                                "index"
                                                            )),
