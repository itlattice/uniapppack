...
open class GenComponentsXInstorageOrder : VueComponent {
    ...
    companion object {
        ...
        var setup: (__props: GenComponentsXInstorageOrder) -> Any? = fun(__props): Any? {
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenComponentsXInstorageOrder
            ...
            val toView = fun(){
                ...
                common.goto("/pages/warehouse/instorage/view?id=" + props.order["id"].toString(), "slide-in-bottom")
            }
            val copyString = fun(){
                paichu()
                ...
                return _cE("view", _uM("class" to "allocate-order background-white space-between", "style" to _nS(_uM("width" to (unref(width) + "rpx"))), "onClick" to toView), _uA(
                    _cE("view", _uM("class" to "orderinfo"), _uA(
                        _cE("view", _uM("class" to "line space-between", "style" to _nS(_uM("width" to ((unref(width) - 20) + "rpx")))), _uA(
                            ...
                            _cE("text", _uM("class" to "statuscontent color-main"), _tD(unref(order)["reason_name"]), 1)
                        ), 4),
                        _cE("view", _uM("class" to "line space-between", "style" to _nS(_uM("width" to ((unref(width) - 20) + "rpx")))), _uA(
                            _cE("view", _uM("class" to "departinfo display-flex"), _uA(
                                _cE("text", _uM("class" to "shop"), _tD(unref(depart)["name"]), 1)
                            )),
                            _cE("view", _uM("class" to "display-flex"), _uA(
                                _cE("text", _uM("class" to "numbers"), "入库数量：" + _tD(unref(order)["total"]), 1),
                                _cE("view", _uM("class" to "person display-flex"), _uA(
                                    _cE("text", _uM("class" to "name"), "单品数:"),
                                    _cE("text", _uM("class" to "content color-red"), _tD(unref(order)["goods_piece"]), 1)
                                ))
                            ))
                        ), 4),
                        _cE("view", _uM("class" to "line space-between", "style" to _nS(_uM("width" to ((unref(width) - 20) + "rpx")))), _uA(
