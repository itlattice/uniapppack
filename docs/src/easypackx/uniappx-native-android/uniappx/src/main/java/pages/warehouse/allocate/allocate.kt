...
open class GenPagesWarehouseAllocateAllocate : BasePage {
    ...
    companion object {
        ...
        var setup: (__props: GenPagesWarehouseAllocateAllocate) -> Any? = fun(__props): Any? {
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenPagesWarehouseAllocateAllocate
            ...
            val getDate = fun(): UTSPromise<Unit> {
                return wrapUTSPromise(suspend {
                        var res = await(request.callapi("common/getdate", _uO("page" to "warehouse/allocate")))
                        dateList.value = res.data as UTSArray<String>
                })
            }
            val getList = fun(): UTSPromise<Unit> {
                return wrapUTSPromise(suspend w1@{
                        var res = await(request.callapi("warehouse/allocate", _uO("date" to dateList.value, "page" to page.value, "keywords" to keywords.value)))
                        if (res.code < 0) {
            ...
            val newOrder = fun(){
                common.goto("/pages/warehouse/allocate/addorder", "slide-in-bottom")
            }
            ...
            return fun(): Any? {
                ...
                val _component_x_allocate_order = resolveEasyComponent("x-allocate-order", GenComponentsXAllocateOrderClass)
                ...
                return _cE("view", null, _uA(
                    _cV(_component_x_viewtitle, _uM("title" to "调拨单"), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                        return _uA(
                    ...
                    _cE("view", _uM("class" to "searchview background-white display-flex"), _uA(
                        ...
                        , "width" to 570, "placeholder" to "调拨单号/备注"), null, 8, _uA(
                            "modelValue"
                        )),
                                                ...
                                                return _cV(_component_x_longpress, _uM("key" to index, "onLongpress" to longPress), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                                                    return _uA(
                                                        _cE("view", _uM("class" to "orderitem display-flex background-white"), _uA(
                                                            _cV(_component_x_allocate_order, _uM("width" to unref(orderWidth), "order" to item, "index" to index, "onErWeima" to erWeima), null, 8, _uA(
                                                                "width",
                                                                "order",
                                                                "index"
                                                            )),
