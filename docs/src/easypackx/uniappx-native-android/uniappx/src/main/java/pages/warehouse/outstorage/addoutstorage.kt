...
open class GenPagesWarehouseOutstorageAddoutstorage : BasePage {
    ...
    companion object {
        ...
        var setup: (__props: GenPagesWarehouseOutstorageAddoutstorage) -> Any? = fun(__props): Any? {
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenPagesWarehouseOutstorageAddoutstorage
            ...
            val goodsList = ref(_uA<outstoragegoodsinfo>())
            val order = ref(_uO())
            ...
            val loadCache = fun(){
                var cacheData = common.getStorage("warehouse_outstorage")
                if (cacheData == "") {
                    return
                }
                ...
                goodsList.value = _uA<outstoragegoodsinfo>()
                for(item in resolveUTSValueIterator(list)){
                    goodsList.value.push(outstoragegoodsinfo(goodsinfo = item["goodsinfo"] as UTSJSONObject, number = item["number"] as Number, price = item["price"] as Number, id = item["id"] as Number, remark = if (item["remark"] == null) {
                        null
                    } else {
                ...
                common.rmStorage("warehouse_outstorage")
            }
            val getData = fun(): UTSPromise<UTSJSONObject?> {
                return wrapUTSPromise(suspend w1@{
                        ...
                        var data: UTSJSONObject = _uO("fromdepart" to fromdepart.value, "depart" to depart.value, "reson" to reson.value, "resonKey" to resonKey.value, "goodsList" to goodsList.value, "order" to order.value, "remark" to remarkbox["remark"] as String, "thumb" to remarkbox["file"] as UTSArray<UTSJSONObject>)
                        return@w1 data
                })
            }
            val draftOrder = fun(): UTSPromise<Unit> {
                return wrapUTSPromise(suspend {
                        ...
                        common.setStorage("warehouse_outstorage", data as Any)
                        common.back()
                })
            }
            val submitOrder = fun(): UTSPromise<Unit> {
                return wrapUTSPromise(suspend w1@{
                        ...
                        var list = data["goodsList"] as UTSArray<outstoragegoodsinfo>
                        ...
                        var requestData: UTSJSONObject = _uO("fromdepart" to fromdepart.value["id"], "order" to bindOrderID, "depart" to departData["id"], "resonkey" to data["resonKey"], "goods" to goods, "remark" to data["remark"], "thumb" to data["thumb"])
                        ...
                        var res = await(request.callapi("warehouse/addoutstorage", requestData))
                        ...
                        common.timeToPage("/pages/warehouse/outstorage/view?id=" + orderID.toString(), true)
                })
            }
            ...
            val loadPageData = fun(): UTSPromise<Unit> {
                return wrapUTSPromise(suspend w1@{
                        var res = await(request.callapi("warehouse/getoutstorageresonlist", _uO()))
                        if (res.code < 0) {
                            common.toast(res.msg)
                            common.back()
                            return@w1
            ...
            val chooseWriteoffOrder = fun(): UTSPromise<Unit> {
                return wrapUTSPromise(suspend {
                })
            }
            val chooseSailOrder = fun(): UTSPromise<Unit> {
                return wrapUTSPromise(suspend w1@{
                        ...
                        for(item in resolveUTSValueIterator(items)){
                            goodsList.value.push(outstoragegoodsinfo(goodsinfo = item["goods_data"] as UTSJSONObject, number = item["number"] as Number, id = item["goods_id"] as Number, remark = if (item["remark"] == null) {
                                ""
                            } else {
                                item["remark"] as String
                            }
            ...
            return fun(): Any? {
                ...
                return _cE("view", null, _uA(
                    _cV(_component_x_viewtitle, _uM("title" to "商品出库"), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                        return _uA(
                    ...
                    _cE("scroll-view", _uM("scroll-y" to true), _uA(
                        _cE("view", null, _uA(
                            _cE("view", _uM("class" to "basicbox background-white width-full"), _uA(
                                            ...
                                            _cE("view", _uM("class" to "linebox display-flex"), _uA(
                                                ...
                                                _cE("view", _uM("class" to "changbox", "onClick" to chooseDepart), _uA(
                                                    if (isTrue(unref(depart)["name"])) {
                                                        ...
                                                        _cE("text", _uM("key" to 1, "class" to "text placeholder"), "选择出库的仓库或门店")
                                                    }
                                                ))
                                            ))
                                        )
                                    ...
                                    _cV(_component_x_triangleinput, _uM("height" to 35, "width" to 710), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                                        return _uA(
                                            _cE("view", _uM("class" to "linebox display-flex", "onClick" to filterTap), _uA(
                                                _cE("text", _uM("class" to "title"), "出库原因"),
                                                _cE("view", _uM("class" to "changbox"), _uA(
                                                    _cV(_component_fui_dropdown_menu, _uM("ref_key" to "resonRange", "ref" to resonRange, "size" to 15, "selectedColor" to "#465CFF", "menus" to unref(resons), "onOnclick" to rangeItemResonClick, "onClose" to rangeResonClose, "isCheckbox" to false), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                                                        return _uA(
                                ...
                                if (unref(resonKey) == "sail") {
                                    _cE("view", _uM("key" to 0, "class" to "lineitem"), _uA(
                                        _cV(_component_x_triangleinput, _uM("height" to 35, "width" to 710), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                                            return _uA(
                                                _cE("view", _uM("class" to "linebox display-flex"), _uA(
                                                    _cE("text", _uM("class" to "title"), "发货单"),
                                                    _cE("view", _uM("class" to "changbox display-flex space-between", "onClick" to chooseSailOrder), _uA(
                                                        if (isTrue(unref(order)["no"])) {
                                                            _cE("text", _uM("key" to 0, "class" to "text"), _tD(unref(order)["no"]) + "(" + _tD(unref(order)["add_date"]) + ")", 1)
                                                        } else {
                                                            _cE("text", _uM("key" to 1, "class" to "text placeholder"), "选择发货单")
                                                        },
                                                        if (isTrue(unref(order)["no"])) {
                                ...
                                ,
                                if (unref(resonKey) == "writeoff") {
                                    _cE("view", _uM("key" to 1, "class" to "lineitem"), _uA(
                                        _cV(_component_x_triangleinput, _uM("height" to 35, "width" to 710), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                                            return _uA(
                                                _cE("view", _uM("class" to "linebox display-flex"), _uA(
                                                    _cE("text", _uM("class" to "title"), "核销单"),
                                                    _cE("view", _uM("class" to "changbox display-flex space-between", "onClick" to chooseWriteoffOrder), _uA(
                                                        if (isTrue(unref(order)["no"])) {
                                                            _cE("text", _uM("key" to 0, "class" to "text"), _tD(unref(order)["no"]) + "(" + _tD(unref(order)["add_date"]) + ")", 1)
                                                        } else {
                                                            _cE("text", _uM("key" to 1, "class" to "text placeholder"), "选择发货单")
                                ...
                                if (unref(resonKey) == "down") {
                                    _cE("view", _uM("key" to 3, "class" to "lineitem"), _uA(
                                        _cV(_component_x_triangleinput, _uM("height" to 35, "width" to 710), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                                            return _uA(
                                                _cE("view", _uM("class" to "linebox display-flex"), _uA(
                    ...
                    _cV(_component_x_order_action, _uM("btn2" to "出库", "active" to (unref(goodsList).length > 0), "onDraft" to draftOrder, "onSubmit" to submitOrder), null, 8, _uA(
                        "active"
                    )),
                    _cV(_component_x_model, _uM("ref" to "model"), null, 512),
