...
open class GenUniModulesIboxsChoosemediaComponentsXuButtommenu : VueComponent {
    constructor(__ins: ComponentInternalInstance) : super(__ins) {}
    @Suppress("UNUSED_PARAMETER", "UNUSED_VARIABLE")
    override fun `$render`(): Any? {
        val _ctx = this
        val _cache = this.`$`.renderCache
        val _component_xu_bottom_popup = resolveComponent("xu-bottom-popup")
        return _cV(_component_xu_bottom_popup, _uM("visible" to _ctx.visible, "onClose" to _ctx.closePopup), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
            return _uA(
    ...
    open var menu: UTSArray<bottomMenu__1> by `$props`
    ...
    companion object {
        ...
        var props = _nP(_uM("menu" to _uM("type" to "Object", "default" to _uA<bottomMenu__1>()), "visible" to _uM("type" to "Boolean", "default" to false)))
        var propsNeedCastKeys = _uA(
            "menu",
            "visible"
        )
        var components: Map<String, CreateVueComponent> = _uM("xuBottomPopup" to GenUniModulesIboxsChoosemediaComponentsXuBottomPopupClass)
    }
}
