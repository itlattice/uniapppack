...
open class GenPagesMemberView : BasePage {
    ...
    companion object {
        ...
        var setup: (__props: GenPagesMemberView) -> Any? = fun(__props): Any? {
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenPagesMemberView
            ...
            return fun(): Any? {
                return _cE("view", null, _tD(unref(id)), 1)
            }
        }
