...
open class GenComponentsXRequiregoodsOrder : VueComponent {
    ...
    companion object {
        ...
        var setup: (__props: GenComponentsXRequiregoodsOrder) -> Any? = fun(__props): Any? {
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenComponentsXRequiregoodsOrder
            ...
            val depart = computed(fun(): UTSJSONObject {
                var depart = props.order["depart"] as UTSJSONObject
                return depart
            }
            )
            val paichu = fun(){
            ...
            val toView = fun(){
                ...
                if (props.select) {
                    emit("selectdata", props.order)
                    return
                }
                common.goto("/pages/warehouse/requiregoods/view?id=" + props.order["id"].toString(), "slide-in-bottom")
            }
            val copyString = fun(){
                paichu()
            ...
            return fun(): Any? {
                ...
                return _cE("view", _uM("class" to "require-order background-white space-between", "style" to _nS(_uM("width" to (unref(width) + "rpx"))), "onClick" to toView), _uA(
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return _uM("require-order" to _pS(_uM("height" to 75, "paddingTop" to 2, "paddingLeft" to "10rpx", "paddingRight" to "10rpx")), "orderno" to _uM(".require-order .orderinfo " to _uM("marginBottom" to 4)), "no" to _uM(".require-order .orderinfo .orderno " to _uM("color" to "#6B6B6B", "fontSize" to 13)), "fuzhiicon" to _uM(".require-order .orderinfo .orderno " to _uM("marginLeft" to "8rpx")), "notag" to _uM(".require-order .orderinfo " to _uM("width" to 40, "height" to 12, "textAlign" to "center", "lineHeight" to "10px", "fontSize" to 8, "color" to "#FF8D1A", "borderTopLeftRadius" to 3, "borderTopRightRadius" to 3, "borderBottomRightRadius" to 3, "borderBottomLeftRadius" to 3, "borderTopWidth" to 1, "borderRightWidth" to 1, "borderBottomWidth" to 1, "borderLeftWidth" to 1, "borderTopStyle" to "solid", "borderRightStyle" to "solid", "borderBottomStyle" to "solid", "borderLeftStyle" to "solid", "borderTopColor" to "#FF8D1A", "borderRightColor" to "#FF8D1A", "borderBottomColor" to "#FF8D1A", "borderLeftColor" to "#FF8D1A", "marginLeft" to "10rpx", "marginTop" to 2)), "robottag" to _uM(".require-order .orderinfo " to _uM("color" to "#ff300c", "borderTopWidth" to 1, "borderRightWidth" to 1, "borderBottomWidth" to 1, "borderLeftWidth" to 1, "borderTopStyle" to "solid", "borderRightStyle" to "solid", "borderBottomStyle" to "solid", "borderLeftStyle" to "solid", "borderTopColor" to "#ff300c", "borderRightColor" to "#ff300c", "borderBottomColor" to "#ff300c", "borderLeftColor" to "#ff300c")), "line" to _uM(".require-order " to _uM("marginBottom" to "15rpx")), "statuscontent" to _uM(".require-order .line " to _uM("fontSize" to 12)), "shop" to _uM(".require-order .line " to _uM("fontSize" to 15)), "name" to _uM(".require-order .line .person " to _uM("fontSize" to 13, "color" to "#6B6B6B")), "content" to _uM(".require-order .line .person " to _uM("fontSize" to 13)), "taskname" to _uM(".require-order .line .mingcheng " to _uM("fontSize" to 13, "marginLeft" to "10rpx")), "person" to _uM(".require-order .line .faqiperson " to _uM("fontSize" to 13, "color" to "#9C9C9C")), "nperson" to _uM(".require-order .line .faqiperson " to _uM("fontSize" to 13)))
            }
        var inheritAttrs = true
        var inject: Map<String, Map<String, Any?>> = _uM()
        var emits: Map<String, Any?> = _uM("selectdata" to null, "erWeima" to null)
