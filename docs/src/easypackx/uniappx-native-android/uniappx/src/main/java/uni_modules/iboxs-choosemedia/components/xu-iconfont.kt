...
open class GenUniModulesIboxsChoosemediaComponentsXuIconfont : VueComponent {
    ...
    override fun data(): Map<String, Any?> {
        return _uM("i18n" to xConfig.i18n as Tmui4xI18nTml, "icons" to default__12 as UTSJSONObject, "getSize" to computed<String>(fun(): String {
            var size: String
    ...
    companion object {
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return _uM("xu-iconfont" to _pS(_uM("fontFamily" to "xiconfont")), "xu-iconfont__color" to _pS(_uM("!color" to "#333333")), "xu-iconfont__active-color" to _pS(_uM("!color" to "#465CFF")), "xu-iconfont__fontsize" to _pS(_uM("!fontSize" to "64rpx", "!lineHeight" to "64rpx")), "@FONT-FACE" to _uM("0" to _uM("fontFamily" to "xiconfont", "src" to "url(\"/uni_modules/iboxs-choosemedia/static/iconfont.ttf\")")))
            }
