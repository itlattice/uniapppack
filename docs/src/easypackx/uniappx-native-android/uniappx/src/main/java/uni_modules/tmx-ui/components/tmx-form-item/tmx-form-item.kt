...
open class GenUniModulesTmxUiComponentsTmxFormItemTmxFormItem : VueComponent {
                        ...
                        renderSlot(_ctx.`$slots`, "label", _uO(), fun(): UTSArray<Any> {
                            return _uA(
                                ...
                                if (isTrue(_ctx._label)) {
                                    _cV(_component_tmx_text, _uM("key" to 1, "fontSize" to _ctx._labelFontSize, "color" to _ctx._labelFontColor, "darkColor" to _ctx._labelFontDarkColor), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                                        return _uA(
                                            _tD(_ctx._label)
                                        )
                                    }), "_" to 1), 8, _uA(
    ...
    open var _labelFontDarkColor: String by `$data`
    ...
    override fun data(): Map<String, Any?> {
        ...
        ), "_labelFontDarkColor" to computed<String>(fun(): String {
            if (xConfig.dark == "dark" && this.labelFontColor == "") {
                return ""
            }
            if (this.labelFontColor != "") {
                return getDefaultColor(this.labelFontColor)
