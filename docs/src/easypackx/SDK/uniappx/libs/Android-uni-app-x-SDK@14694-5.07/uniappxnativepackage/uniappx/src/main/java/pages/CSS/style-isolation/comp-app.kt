...
open class GenPagesCSSStyleIsolationCompApp : VueComponent {
    constructor(__ins: ComponentInternalInstance) : super(__ins) {}
    companion object {
        @Suppress("UNUSED_PARAMETER", "UNUSED_VARIABLE")
        var setup: (__props: GenPagesCSSStyleIsolationCompApp) -> Any? = fun(__props): Any? {
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenPagesCSSStyleIsolationCompApp
            ...
            return fun(): Any? {
                return _cE("view", _uM("class" to "component-container"), _uA(
                    ...
                    _cE("view", _uM("class" to "global-box"), _uA(
                        _cE("text", _uM("class" to "global-text com-text"), "全局样式(预期字体大小18px)")
                    )),
                    _cE("view", _uM("class" to "page-box"), _uA(
                        _cE("text", _uM("class" to "com-text font-size page-text"), "页面样式(预期默认字体大小16px)")
                    )),
