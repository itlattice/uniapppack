...
open class GenPagesComponentRichTextRichTextList : BasePage {
    ...
    companion object {
        ...
        var setup: (__props: GenPagesComponentRichTextRichTextList) -> Any? = fun(__props): Any? {
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenPagesComponentRichTextRichTextList
            val _cache = __ins.renderCache
            val text = ref("<h2>uni-app x，终极跨平台方案</h2>")
            return fun(): Any? {
                ...
                return _cE("view", _uM("style" to _nS(_uM("flex" to "1"))), _uA(
                    _cE("list-view", _uM("style" to _nS(_uM("flex" to "1"))), _uA(
                        _cE(Fragment, null, RenderHelpers.renderList(5, fun(index, __key, __index, _cached): Any {
                            return _cE("list-item", _uM("key" to index, "type" to "1", "name" to index), _uA(
                                _cV(_component_rich_text, _uM("nodes" to unref(text)), null, 8, _uA(
                                    "nodes"
                                )),
