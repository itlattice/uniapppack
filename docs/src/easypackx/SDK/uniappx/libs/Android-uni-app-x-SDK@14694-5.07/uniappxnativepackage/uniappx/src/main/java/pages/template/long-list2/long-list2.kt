...
open class GenPagesTemplateLongList2LongList2 : BasePage {
    ...
    companion object {
        ...
        var setup: (__props: GenPagesTemplateLongList2LongList2) -> Any? = fun(__props): Any? {
            ...
            var swiperTabsRect: UTSArray<SwiperTabsItem__3> = _uA()
            ...
            fun gen_onNestedPreScroll_fn(event: NestedPreScrollEvent) {
                ...
                if (deltaY > 0) {
                    if (scrollTop < headerHeight) {
                        val difference = headerHeight - scrollTop - deltaY
                        if (difference > 0) {
                ...
                return wrapUTSPromise(suspend {
                        ...
                        run {
                            ...
                            while(i < tabs.length){
                                ...
                                swiperTabsRect.push(SwiperTabsItem__3(x = x, w = w))
                                i++
                            }
                        }
                })
