...
open class GenPagesCSSTransitionTransitionDuration : BasePage {
    ...
    companion object {
        ...
        var setup: (__props: GenPagesCSSTransitionTransitionDuration, __setupCtx: SetupContext) -> Any? = fun(__props, __setupCtx): Any? {
            val __expose = __setupCtx.expose
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenPagesCSSTransitionTransitionDuration
            ...
            val data = reactive(_uO("transitionDurationDynamic" to "2s", "transitionDurationActual" to "", "transitionDurationActualText" to "", "transitionDurationActualImage" to "", "transitionDurationActualFlat" to "", "transitionDurationActualTextFlat" to "", "transitionDurationActualImageFlat" to ""))
            ...
            val changeTransitionDurationDynamic = fun(value: String){
            ...
            val radioChangeTransitionDuration = fun(index: Number){
                val selectedItem = transitionDurationEnum.find(fun(item): Boolean {
            ...
            val inputChangeTransitionDuration = fun(value: String){
            ...
            __expose(_uM("jest_start" to jest_start, "jest_reset" to jest_reset, "data" to data))
            return fun(): Any? {
                val _component_enum_data = resolveEasyComponent("enum-data", GenComponentsEnumDataEnumDataClass)
                val _component_input_data = resolveEasyComponent("input-data", GenComponentsInputDataInputDataClass)
                return _cE("scroll-view", _uM("style" to _nS(_uM("flex" to "1"))), _uA(
                    _cE("view", null, _uA(
                        _cE("text", _uM("class" to "uni-title-text"), "view 组件 transition-duration：2s "),
                        ...
                        _cE("text", _uM("class" to "uni-title-text uni-common-mt"), "text 组件 transition-duration: 2s"),
                        _cE("text", _uM("class" to _nC(unref(textClassValue))), "transition-duration: 2s", 2),
                        _cE("view", _uM("class" to "button-container"), _uA(
                        ...
                        _cE("text", _uM("class" to "uni-title-text uni-common-mt"), "image 组件 transition-duration: 2s"),
                        ...
                        _cE("text", _uM("class" to "uni-title-text uni-common-mt"), "scroll-view 组件 transition-duration: 2s"),
                        ...
                        _cE("view", _uM("class" to "uni-common-mt"), _uA(
                            _cE("text", _uM("class" to "uni-title-text"), "setProperty 设置与 getPropertyValue 获取 transition-duration ")
                        )),
                        _cE("view", _uM("class" to "test-container"), _uA(
                            _cE("view", _uM("class" to "test-item"), _uA(
                                ...
                                _cE("text", _uM("class" to "uni-info"), "设置值: " + _tD(unref(data)["transitionDurationDynamic"]), 1),
                                _cE("text", _uM("class" to "uni-info"), "获取值: " + _tD(unref(data)["transitionDurationActual"]), 1),
                                _cE("view", _uM("class" to "test-box"), _uA(
                                    _cE("view", _uM("ref_key" to "viewRefDynamic", "ref" to viewRefDynamic, "class" to "common-image", "style" to _nS(_uM("transitionDuration" to unref(data)["transitionDurationDynamic"], "transitionProperty" to "width")), "onClick" to triggerTransitionDynamic), _uA(
                            ...
                            _cE("view", _uM("class" to "test-item"), _uA(
                                ...
                                _cE("text", _uM("class" to "uni-info"), "设置值: " + _tD(unref(data)["transitionDurationDynamic"]), 1),
                                _cE("text", _uM("class" to "uni-info"), "获取值: " + _tD(unref(data)["transitionDurationActualText"]), 1),
                                _cE("view", _uM("class" to "test-box"), _uA(
                                    _cE("text", _uM("ref_key" to "textRefDynamic", "ref" to textRefDynamic, "class" to "common-text", "style" to _nS(_uM("transitionDuration" to unref(data)["transitionDurationDynamic"], "transitionProperty" to "width")), "onClick" to triggerTransitionTextDynamic), "点击text", 4)
                                ))
                            )),
                            _cE("view", _uM("class" to "test-item"), _uA(
                                _cE("text", _uM("class" to "uni-subtitle-text"), "image 组件"),
                                _cE("text", _uM("class" to "uni-info"), "设置值: " + _tD(unref(data)["transitionDurationDynamic"]), 1),
                                _cE("text", _uM("class" to "uni-info"), "获取值: " + _tD(unref(data)["transitionDurationActualImage"]), 1),
                                _cE("view", _uM("class" to "test-box"), _uA(
                                    _cE("image", _uM("ref_key" to "imageRefDynamic", "ref" to imageRefDynamic, "class" to "common-image", "style" to _nS(_uM("transitionDuration" to unref(data)["transitionDurationDynamic"], "transitionProperty" to "width")), "onClick" to triggerTransitionImageDynamic, "src" to "/static/test-image/logo.png"), null, 4)
                                ))
                            ))
                        )),
                        _cE("view", _uM("class" to "test-container"), _uA(
                            _cE("view", _uM("class" to "test-item"), _uA(
                                ...
                                _cE("text", _uM("class" to "uni-info"), "设置值: " + _tD(unref(data)["transitionDurationDynamic"]), 1),
                                _cE("text", _uM("class" to "uni-info"), "获取值: " + _tD(unref(data)["transitionDurationActualFlat"]), 1),
                                _cE("view", _uM("class" to "test-box"), _uA(
                                    _cE("view", _uM("ref_key" to "viewRefDynamicFlat", "ref" to viewRefDynamicFlat, "class" to "common-image", "style" to _nS(_uM("transitionDuration" to unref(data)["transitionDurationDynamic"], "transitionProperty" to "width")), "onClick" to triggerTransitionDynamic, "flatten" to ""), _uA(
                                        _cE("text", _uM("style" to _nS(_uM("font-size" to "12px"))), "点击view", 4)
                                    ), 4)
                                ))
                            )),
                            _cE("view", _uM("class" to "test-item"), _uA(
                                ...
                                _cE("text", _uM("class" to "uni-info"), "设置值: " + _tD(unref(data)["transitionDurationDynamic"]), 1),
                                _cE("text", _uM("class" to "uni-info"), "获取值: " + _tD(unref(data)["transitionDurationActualTextFlat"]), 1),
                                _cE("view", _uM("class" to "test-box"), _uA(
                                    _cE("text", _uM("ref_key" to "textRefDynamicFlat", "ref" to textRefDynamicFlat, "class" to "common-text", "style" to _nS(_uM("transitionDuration" to unref(data)["transitionDurationDynamic"], "transitionProperty" to "width")), "onClick" to triggerTransitionTextDynamic, "flatten" to ""), "点击text", 4)
                                ))
                            )),
                            _cE("view", _uM("class" to "test-item"), _uA(
                                _cE("text", _uM("class" to "uni-subtitle-text"), "image 组件拍平"),
                                _cE("text", _uM("class" to "uni-info"), "设置值: " + _tD(unref(data)["transitionDurationDynamic"]), 1),
                                _cE("text", _uM("class" to "uni-info"), "获取值: " + _tD(unref(data)["transitionDurationActualImageFlat"]), 1),
                                _cE("view", _uM("class" to "test-box"), _uA(
                                    _cE("image", _uM("ref_key" to "imageRefDynamicFlat", "ref" to imageRefDynamicFlat, "class" to "common-image", "style" to _nS(_uM("transitionDuration" to unref(data)["transitionDurationDynamic"], "transitionProperty" to "width")), "onClick" to triggerTransitionImageDynamic, "src" to "/static/test-image/logo.png", "flatten" to ""), null, 4)
                                ))
                            ))
                        )),
                        _cE("view", _uM("class" to "uni-common-mt uni-common-mb"), _uA(
                            _cE("text", _uM("class" to "uni-tips"), "第一个枚举值，'' (空字符串) - 空值情况"),
                            _cV(_component_enum_data, _uM("items" to transitionDurationEnum, "title" to "transition-duration 枚举值", "onChange" to radioChangeTransitionDuration, "compact" to true)),
                            _cV(_component_input_data, _uM("defaultValue" to unref(data)["transitionDurationDynamic"], "title" to "transition-duration 自定义值", "type" to "text", "onConfirm" to inputChangeTransitionDuration), null, 8, _uA(
                                "defaultValue"
                            ))
                        )),
                        _cE("text", _uM("class" to "uni-title-text uni-common-mt uni-common-mb"), "native-view 组件 transition-duration: 2s"),
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return _uM("box" to _pS(_uM("width" to 200, "height" to 50, "backgroundColor" to "#0000FF")), "ani" to _pS(_uM("transitionDuration" to "2s", "width" to 300)), "text-box" to _pS(_uM("width" to 200, "height" to 60, "paddingTop" to 10, "paddingRight" to 10, "paddingBottom" to 10, "paddingLeft" to 10, "fontSize" to 16, "backgroundColor" to "#ADD8E6", "textAlign" to "center")), "text-ani" to _pS(_uM("transitionDuration" to "2s", "width" to 300)), "image-box" to _pS(_uM("width" to 100, "height" to 100)), "image-ani" to _pS(_uM("transitionDuration" to "2s", "width" to 150, "height" to 150)), "common-text" to _pS(_uM("width" to 50, "height" to 50, "backgroundColor" to "#008000", "fontSize" to 12, "color" to "#FFFFFF")), "common-image" to _pS(_uM("width" to 50, "height" to 50, "backgroundColor" to "#008000")), "scroll-view-box" to _pS(_uM("width" to 200, "height" to 50, "backgroundColor" to "#008000")), "scroll-view-ani" to _pS(_uM("transitionDuration" to "2s", "width" to 300)), "native-view-box" to _pS(_uM("width" to 200, "height" to 50, "backgroundColor" to "#008000")), "native-view-ani" to _pS(_uM("transitionProperty" to "width", "transitionDuration" to "2s", "width" to 300)), "test-container" to _pS(_uM("flexDirection" to "row", "justifyContent" to "space-between", "marginTop" to 10)), "test-item" to _pS(_uM("flexGrow" to 1, "flexShrink" to 1, "flexBasis" to "0%", "marginTop" to 0, "marginRight" to 5, "marginBottom" to 0, "marginLeft" to 5)), "test-box" to _pS(_uM("width" to "100%", "height" to 80, "backgroundColor" to "#808080")), "demo-box" to _pS(_uM("flexDirection" to "row", "justifyContent" to "space-around", "marginTop" to 10)), "button-container" to _pS(_uM("flexDirection" to "row", "marginTop" to 10, "paddingBottom" to 15, "borderBottomWidth" to 1, "borderBottomStyle" to "solid", "borderBottomColor" to "#d3d3d3")), "button-item" to _pS(_uM("marginRight" to 10)), "@TRANSITION" to _uM("ani" to _uM("duration" to "2s"), "text-ani" to _uM("duration" to "2s"), "image-ani" to _uM("duration" to "2s"), "scroll-view-ani" to _uM("duration" to "2s"), "native-view-ani" to _uM("property" to "width", "duration" to "2s")))
            }
