...
open class GenPagesComponentMapMap : BasePage {
    ...
    companion object {
        ...
        var setup: (__props: GenPagesComponentMapMap, __setupCtx: SetupContext) -> Any? = fun(__props, __setupCtx): Any? {
            ...
            val addControls = fun(){
                controls.value = _uA(
                    Control(id = 1, position = ControlPosition(left = 5, top = 180, width = 30, height = 30), iconPath = "../../../static/test-image/logo.png", clickable = true)
                )
            }
            ...
            return fun(): Any? {
                ...
                return _cE("view", _uM("class" to "content"), _uA(
                    ...
                    _cE("scroll-view", _uM("class" to "scrollview"), _uA(
