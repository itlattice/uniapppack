    ...
    companion object {
        ...
        var setup: (__props: GenPagesTemplateLongListLongListPage, __setupCtx: SetupContext) -> Any? = fun(__props, __setupCtx): Any? {
            ...
            fun gen_loadData_fn(loadComplete: (() -> Unit)?) {
                ...
                uni_request<ResponseDataType>(RequestOptions(url = SERVER_URL, data = _uO("type" to props.type, "page" to currentPage.value, "page_size" to PAGE_SIZE), success = fun(res){
