...
open class GenPagesCSSDisplayFlex : BasePage {
    ...
    companion object {
        ...
        var setup: (__props: GenPagesCSSDisplayFlex, __setupCtx: SetupContext) -> Any? = fun(__props, __setupCtx): Any? {
            val __expose = __setupCtx.expose
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenPagesCSSDisplayFlex
            val _cache = __ins.renderCache
            val data = reactive(_uO("display" to "flex", "displayProp" to "flex", "displayActual" to "", "displayActualText" to "", "displayActualImage" to ""))
            ...
            return fun(): Any? {
                ...
                return _cE("scroll-view", _uM("style" to _nS(_uM("flex" to "1"))), _uA(
                    _cE("view", null, _uA(
                        ...
                        _cE("button", _uM("onClick" to switchDisplay, "class" to "uni-common-mb"), "切换display属性"),
                        _cE("text", _uM("class" to "uni-title-text uni-common-mt"), "scroll-view 组件"),
                        _cE("text", _uM("class" to "uni-subtitle-text"), "display: flex 和 display: none"),
                        _cE("view", _uM("class" to "demo-box"), _uA(
                            _cE("scroll-view", _uM("class" to "common-view", "style" to _nS(_uM("display" to "flex"))), _uA(
                                _cE("text", _uM("class" to "common-text"), "display: flex")
                            ), 4),
                            _cE("scroll-view", _uM("class" to "common-view", "style" to _nS(_uM("display" to "none"))), _uA(
                                _cE("text", _uM("class" to "common-text"), "display: none")
                            ), 4)
                        )),
                        ...
                        _cE("view", _uM("class" to "uni-common-mb"), _uA(
                            _cE("text", null, "native-view组件: display: flex 和 display: none"),
                            _cE("view", _uM("class" to "demo-box"), _uA(
                                _cE("native-view", _uM("class" to "common-view", "style" to _nS(_uM("display" to "flex", "width" to "100px"))), null, 4),
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return _uM("page" to _pS(_uM("height" to "100%")), "head" to _pS(_uM("marginTop" to 10, "marginBottom" to 10, "alignItems" to "center")), "tip" to _pS(_uM("color" to "#FF0000")), "content" to _pS(_uM("borderTopWidth" to 5, "borderRightWidth" to 5, "borderBottomWidth" to 5, "borderLeftWidth" to 5, "borderTopStyle" to "dotted", "borderRightStyle" to "dotted", "borderBottomStyle" to "dotted", "borderLeftStyle" to "dotted", "borderTopColor" to "#0000FF", "borderRightColor" to "#0000FF", "borderBottomColor" to "#0000FF", "borderLeftColor" to "#0000FF", "marginTop" to 10, "marginRight" to "auto", "marginBottom" to 10, "marginLeft" to "auto", "paddingTop" to 30, "paddingRight" to 30, "paddingBottom" to 30, "paddingLeft" to 30, "width" to 200, "height" to 150, "backgroundColor" to "#808080", "alignItems" to "center", "justifyContent" to "center")), "test-container" to _pS(_uM("flexDirection" to "row", "marginTop" to 10)), "test-item" to _pS(_uM("flexGrow" to 1, "flexShrink" to 1, "flexBasis" to "0%", "marginTop" to 0, "marginRight" to 5, "marginBottom" to 0, "marginLeft" to 5)), "test-box" to _pS(_uM("width" to "100%", "height" to 60, "backgroundColor" to "#808080")), "common-view" to _pS(_uM("height" to 50, "backgroundColor" to "#008000")), "common-text" to _pS(_uM("height" to 50, "backgroundColor" to "#008000", "fontSize" to 12, "color" to "#FFFFFF")), "common-image" to _pS(_uM("width" to 50, "height" to 50, "backgroundColor" to "#008000")), "demo-box" to _pS(_uM("flexDirection" to "row", "justifyContent" to "space-around", "marginTop" to 10)))
            }
