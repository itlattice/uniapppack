...
open class GenPagesCSSMarginMargin : BasePage {
    ...
    companion object {
        ...
        var setup: (__props: GenPagesCSSMarginMargin, __setupCtx: SetupContext) -> Any? = fun(__props, __setupCtx): Any? {
            val __expose = __setupCtx.expose
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenPagesCSSMarginMargin
            val _cache = __ins.renderCache
            val data = reactive(_uO("margin" to "25px", "marginActual" to "", "marginActualText" to "", "marginActualImage" to "", "marginActualFlat" to "", "marginActualTextFlat" to "", "marginActualImageFlat" to "", "marginActualScrollView" to ""))
            ...
            val radioChangeMargin = fun(index: Number){
                val selectedItem = marginEnum.find(fun(item): Boolean {
                    ...
                    _cE("view", _uM("style" to _nS(_uM("flex-grow" to "1"))), _uA(
                        ...
                        _cE("view", null, _uA(
                            ...
                            _cE("view", _uM("class" to "demo-box"), _uA(
                                ...
                                _cE("view", _uM("class" to "demo-container"), _uA(
                                    _cE("view", _uM("class" to "common red")),
                                    _cE("view", _uM("class" to "common", "style" to _nS(_uM("margin" to "25px")), "flatten" to ""), null, 4),
                                    _cE("view", _uM("class" to "common blue"))
                                ))
                            ))
                        )),
                        _cE("view", null, _uA(
                            ...
                            _cE("view", _uM("class" to "demo-box"), _uA(
                                ...
                                _cE("view", _uM("class" to "demo-container"), _uA(
                                    _cE("view", _uM("class" to "common red")),
                                    _cE("view", _uM("class" to "common", "style" to _nS(_uM("margin" to "10%")), "flatten" to ""), null, 4),
                                    _cE("view", _uM("class" to "common blue"))
                                ))
                            ))
                        )),
                        ...
                        _cE("view", _uM("class" to "test-container"), _uA(
                            _cE("view", _uM("class" to "test-item"), _uA(
                                ...
                                _cE("view", _uM("class" to "test-box"), _uA(
                                    ...
                                    _cE("view", _uM("ref_key" to "viewRef", "ref" to viewRef, "class" to "common-view test-view", "style" to _nS(_uM("margin" to unref(data)["margin"]))), _uA(
                            ...
                            _cE("view", _uM("class" to "test-item"), _uA(
                                ...
                                _cE("view", _uM("class" to "test-box"), _uA(
                                    ...
                                    _cE("text", _uM("ref_key" to "textRef", "ref" to textRef, "class" to "common-view common-text test-text", "style" to _nS(_uM("margin" to unref(data)["margin"]))), "text", 4),
                        ...
                        _cE("view", _uM("class" to "test-container"), _uA(
                            _cE("view", _uM("class" to "test-item"), _uA(
                                ...
                                _cE("view", _uM("class" to "test-box"), _uA(
                                    _cE("view", _uM("class" to "common-view", "style" to _nS(_uM("background-color" to "red"))), null, 4),
                                    _cE("view", _uM("ref_key" to "viewRefFlat", "ref" to viewRefFlat, "class" to "common-view test-view-flatten", "style" to _nS(_uM("margin" to unref(data)["margin"])), "flatten" to ""), _uA(
                                        _cE("text", _uM("class" to "common-text"), "view")
                                    ), 4),
                                    _cE("view", _uM("class" to "common-view", "style" to _nS(_uM("background-color" to "blue"))), null, 4)
                                ))
                            ...
                            _cE("view", _uM("class" to "test-item"), _uA(
                                ...
                                _cE("view", _uM("class" to "test-box"), _uA(
                                    _cE("text", _uM("class" to "common-view common-text", "style" to _nS(_uM("background-color" to "red"))), "红色", 4),
                                    _cE("text", _uM("ref_key" to "textRefFlat", "ref" to textRefFlat, "class" to "common-view common-text test-text-flatten", "style" to _nS(_uM("margin" to unref(data)["margin"])), "flatten" to ""), "text", 4),
                                    _cE("text", _uM("class" to "common-view common-text", "style" to _nS(_uM("background-color" to "blue"))), "蓝色", 4)
                                ))
                            )),
                            _cE("view", _uM("class" to "test-item"), _uA(
                        ...
                        _cE("view", _uM("class" to "uni-common-mt"), _uA(
                            _cE("text", _uM("class" to "uni-title-text"), "scroll-view 组件 margin ")
                        )),
                        _cE("view", _uM("class" to "test-container"), _uA(
                            _cE("view", _uM("class" to "test-item"), _uA(
                                _cE("text", _uM("class" to "uni-info"), "设置值: " + _tD(unref(data)["margin"]), 1),
                                _cE("text", _uM("class" to "uni-info"), "获取值: " + _tD(unref(data)["marginActualScrollView"]), 1),
                                _cE("view", _uM("class" to "test-box", "style" to _nS(_uM("height" to "180px"))), _uA(
                                    _cE("view", _uM("class" to "common-view", "style" to _nS(_uM("background-color" to "red"))), null, 4),
                                    _cE("scroll-view", _uM("ref_key" to "scrollViewRef", "ref" to scrollViewRef, "class" to "common-scroll-view", "style" to _nS(_uM("margin" to unref(data)["margin"]))), _uA(
                        ...
                        _cE("view", _uM("class" to "uni-common-mt uni-common-mb"), _uA(
                            ...
                            _cV(_component_enum_data, _uM("compact" to true, "items" to marginEnum, "title" to "margin 枚举值", "onChange" to radioChangeMargin)),
                        ...
                        _cE("view", _uM("class" to "uni-common-mb"), _uA(
                            _cE("text", null, "native-view组件: margin: 25px 和 5%"),
                            _cE("view", _uM("class" to "demo-box"), _uA(
                                _cE("view", _uM("class" to "demo-container"), _uA(
                                    _cE("view", _uM("class" to "common red")),
                                    _cE("native-view", _uM("class" to "common", "style" to _nS(_uM("margin" to "25px"))), null, 4),
                                    _cE("view", _uM("class" to "common blue"))
                                )),
                                _cE("view", _uM("class" to "demo-container"), _uA(
                                    _cE("view", _uM("class" to "common red")),
                                    _cE("native-view", _uM("class" to "common", "style" to _nS(_uM("margin" to "10%"))), null, 4),
                                    _cE("view", _uM("class" to "common blue"))
                                ))
                            ))
                        ))
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return _uM("demo-container" to _pS(_uM("flexGrow" to 1, "flexShrink" to 1, "flexBasis" to "0%", "marginTop" to 0, "marginRight" to 10, "marginBottom" to 0, "marginLeft" to 10, "height" to 220, "backgroundColor" to "#808080")), "demo-box" to _pS(_uM("flexDirection" to "row", "marginTop" to 10, "justifyContent" to "space-around")), "common" to _pS(_uM("height" to 50, "backgroundColor" to "#008000")), "red" to _pS(_uM("backgroundColor" to "#FF0000")), "blue" to _pS(_uM("backgroundColor" to "#0000FF")), "common-view" to _pS(_uM("height" to 30, "backgroundColor" to "#008000")), "common-text" to _pS(_uM("fontSize" to 12, "color" to "#FFFFFF")), "common-image" to _pS(_uM("width" to 30, "height" to 30, "backgroundColor" to "#008000")), "test-container" to _pS(_uM("flexDirection" to "row", "justifyContent" to "space-between", "marginTop" to 10)), "test-item" to _pS(_uM("flexGrow" to 1, "flexShrink" to 1, "flexBasis" to "0%", "marginTop" to 0, "marginRight" to 5, "marginBottom" to 0, "marginLeft" to 5)), "test-box" to _pS(_uM("width" to "100%", "height" to 140, "backgroundColor" to "#808080")), "common-scroll-view" to _pS(_uM("height" to 30, "backgroundColor" to "#008000")), "scroll-view-content" to _pS(_uM("width" to "100%", "height" to 30, "alignItems" to "center", "justifyContent" to "center", "borderTopWidth" to 2, "borderRightWidth" to 2, "borderBottomWidth" to 2, "borderLeftWidth" to 2, "borderTopStyle" to "solid", "borderRightStyle" to "solid", "borderBottomStyle" to "solid", "borderLeftStyle" to "solid", "borderTopColor" to "#00FFFF", "borderRightColor" to "#00FFFF", "borderBottomColor" to "#00FFFF", "borderLeftColor" to "#00FFFF")), "native-view-container" to _pS(_uM("width" to 100, "height" to 100, "backgroundColor" to "#e0e0e0", "borderTopWidth" to 1, "borderRightWidth" to 1, "borderBottomWidth" to 1, "borderLeftWidth" to 1, "borderTopStyle" to "solid", "borderRightStyle" to "solid", "borderBottomStyle" to "solid", "borderLeftStyle" to "solid", "borderTopColor" to "#999999", "borderRightColor" to "#999999", "borderBottomColor" to "#999999", "borderLeftColor" to "#999999")), "native-view" to _pS(_uM("width" to "100%", "height" to "100%", "backgroundColor" to "#00FFFF")))
            }
