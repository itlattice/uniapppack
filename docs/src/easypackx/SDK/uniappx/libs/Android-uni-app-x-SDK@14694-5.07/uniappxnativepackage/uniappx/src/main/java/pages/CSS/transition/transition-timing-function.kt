...
open class GenPagesCSSTransitionTransitionTimingFunction : BasePage {
    ...
    open var radioChangeTransitionTimingFunction: (index: Number) -> Unit
        get() {
            return unref(this.`$exposed`["radioChangeTransitionTimingFunction"]) as (index: Number) -> Unit
        }
        set(value) {
            setRefValue(this.`$exposed`, "radioChangeTransitionTimingFunction", value)
        }
    ...
    companion object {
        ...
        var setup: (__props: GenPagesCSSTransitionTransitionTimingFunction, __setupCtx: SetupContext) -> Any? = fun(__props, __setupCtx): Any? {
            val __expose = __setupCtx.expose
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenPagesCSSTransitionTransitionTimingFunction
            ...
            val data = reactive(_uO("transitionTimingFunctionDynamic" to "ease", "transitionTimingFunctionActual" to "", "transitionTimingFunctionActualText" to "", "transitionTimingFunctionActualImage" to ""))
            ...
            val transitionTimingFunctionEnum = _uA(
                ItemType(value = 0, name = ""),
                ItemType(value = 1, name = "ease"),
                ItemType(value = 2, name = "ease-in"),
                ItemType(value = 3, name = "ease-out"),
                ItemType(value = 4, name = "ease-in-out"),
                ItemType(value = 5, name = "linear"),
                ItemType(value = 6, name = "cubic-bezier(0.42, 0, 0.58, 1)")
            ...
            val changeTransitionTimingFunctionDynamic = fun(value: String){
            ...
            val radioChangeTransitionTimingFunction = fun(index: Number){
                val selectedItem = transitionTimingFunctionEnum.find(fun(item): Boolean {
            ...
            val inputChangeTransitionTimingFunction = fun(value: String){
            ...
            __expose(_uM("jest_start" to jest_start, "jest_reset" to jest_reset, "radioChangeTransitionTimingFunction" to radioChangeTransitionTimingFunction, "data" to data))
            return fun(): Any? {
                val _component_enum_data = resolveEasyComponent("enum-data", GenComponentsEnumDataEnumDataClass)
                val _component_input_data = resolveEasyComponent("input-data", GenComponentsInputDataInputDataClass)
                return _cE("scroll-view", _uM("style" to _nS(_uM("flex" to "1"))), _uA(
                    _cE("view", null, _uA(
                        _cE("text", _uM("class" to "uni-title-text uni-common-mt"), "view 组件 transition-timing-function：linear"),
                        ...
                        _cE("text", _uM("class" to "uni-title-text uni-common-mt"), "text 组件 transition-timing-function：ease-in-out"),
                        _cE("text", _uM("class" to _nC(unref(textClassValue))), "timing-function: ease-in-out", 2),
                        _cE("view", _uM("class" to "button-container"), _uA(
                        ...
                        _cE("text", _uM("class" to "uni-title-text uni-common-mt"), "image 组件 transition-timing-function：ease"),
                        ...
                        _cE("text", _uM("class" to "uni-title-text uni-common-mt"), "scroll-view 组件 transition-timing-function：ease-in-out"),
                        ...
                        _cE("view", _uM("class" to "uni-common-mt"), _uA(
                            _cE("text", _uM("class" to "uni-title-text"), "setProperty 设置与 getPropertyValue 获取 transition-timing-function ")
                        )),
                        _cE("view", _uM("class" to "test-container"), _uA(
                            _cE("view", _uM("class" to "test-item"), _uA(
                                ...
                                _cE("text", _uM("class" to "uni-info"), "设置值: " + _tD(unref(data)["transitionTimingFunctionDynamic"]), 1),
                                _cE("text", _uM("class" to "uni-info"), "获取值: " + _tD(unref(data)["transitionTimingFunctionActual"]), 1),
                                _cE("view", _uM("class" to "test-box"), _uA(
                                    _cE("view", _uM("ref_key" to "viewRefDynamic", "ref" to viewRefDynamic, "class" to "common-image test-view", "style" to _nS(_uM("transitionTimingFunction" to unref(data)["transitionTimingFunctionDynamic"], "transitionProperty" to "width", "transitionDuration" to "2s")), "onClick" to triggerTransitionDynamic), _uA(
                            ...
                            _cE("view", _uM("class" to "test-item"), _uA(
                                ...
                                _cE("text", _uM("class" to "uni-info"), "设置值: " + _tD(unref(data)["transitionTimingFunctionDynamic"]), 1),
                                _cE("text", _uM("class" to "uni-info"), "获取值: " + _tD(unref(data)["transitionTimingFunctionActualText"]), 1),
                                _cE("view", _uM("class" to "test-box"), _uA(
                                    _cE("text", _uM("ref_key" to "textRefDynamic", "ref" to textRefDynamic, "class" to "common-text test-text", "style" to _nS(_uM("transitionTimingFunction" to unref(data)["transitionTimingFunctionDynamic"], "transitionProperty" to "width", "transitionDuration" to "2s")), "onClick" to triggerTransitionTextDynamic), "点击text", 4)
                                ))
                            )),
                            _cE("view", _uM("class" to "test-item"), _uA(
                                _cE("text", _uM("class" to "uni-subtitle-text"), "image 组件"),
                                _cE("text", _uM("class" to "uni-info"), "设置值: " + _tD(unref(data)["transitionTimingFunctionDynamic"]), 1),
                                _cE("text", _uM("class" to "uni-info"), "获取值: " + _tD(unref(data)["transitionTimingFunctionActualImage"]), 1),
                                _cE("view", _uM("class" to "test-box"), _uA(
                                    _cE("image", _uM("ref_key" to "imageRefDynamic", "ref" to imageRefDynamic, "class" to "common-image test-image", "style" to _nS(_uM("transitionTimingFunction" to unref(data)["transitionTimingFunctionDynamic"], "transitionProperty" to "width", "transitionDuration" to "2s")), "onClick" to triggerTransitionImageDynamic, "src" to "/static/test-image/logo.png"), null, 4)
                                ))
                            ))
                        )),
                        _cE("view", _uM("class" to "uni-common-mt uni-common-mb"), _uA(
                            _cE("text", _uM("class" to "uni-tips"), "第一个枚举值，'' (空字符串) - 空值情况"),
                            _cV(_component_enum_data, _uM("items" to transitionTimingFunctionEnum, "title" to "transition-timing-function 枚举值", "onChange" to radioChangeTransitionTimingFunction, "compact" to true)),
                            _cV(_component_input_data, _uM("defaultValue" to unref(data)["transitionTimingFunctionDynamic"], "title" to "transition-timing-function 自定义值", "type" to "text", "onConfirm" to inputChangeTransitionTimingFunction), null, 8, _uA(
                                "defaultValue"
                            ))
                        )),
                        _cE("text", _uM("class" to "uni-title-text uni-common-mt uni-common-mb"), "native-view 组件 transition-timing-function：ease-in-out"),
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return _uM("box" to _pS(_uM("width" to 200, "height" to 50, "backgroundColor" to "#0000FF")), "ani" to _pS(_uM("transitionProperty" to "width", "transitionDuration" to "2s", "transitionTimingFunction" to "linear", "width" to 300)), "text-box" to _pS(_uM("width" to 200, "height" to 60, "paddingTop" to 10, "paddingRight" to 10, "paddingBottom" to 10, "paddingLeft" to 10, "fontSize" to 16, "backgroundColor" to "#ADD8E6", "textAlign" to "center")), "text-ani" to _pS(_uM("transitionProperty" to "width", "transitionDuration" to "2s", "transitionTimingFunction" to "ease-in-out", "width" to 300)), "image-box" to _pS(_uM("width" to 100, "height" to 100)), "image-ani" to _pS(_uM("transitionProperty" to "width,height", "transitionDuration" to "2s", "transitionTimingFunction" to "ease", "width" to 150, "height" to 150)), "common-text" to _pS(_uM("width" to 50, "height" to 50, "backgroundColor" to "#008000", "fontSize" to 12, "color" to "#FFFFFF")), "common-image" to _pS(_uM("width" to 50, "height" to 50, "backgroundColor" to "#008000")), "scroll-view-box" to _pS(_uM("width" to 200, "height" to 50, "backgroundColor" to "#008000")), "scroll-view-ani" to _pS(_uM("transitionProperty" to "width", "transitionDuration" to "2s", "transitionTimingFunction" to "ease-in-out", "width" to 300)), "native-view-box" to _pS(_uM("width" to 200, "height" to 50, "backgroundColor" to "#008000")), "native-view-ani" to _pS(_uM("transitionProperty" to "width", "transitionDuration" to "2s", "transitionTimingFunction" to "ease-in-out", "width" to 300)), "test-container" to _pS(_uM("flexDirection" to "row", "justifyContent" to "space-between", "marginTop" to 10)), "test-item" to _pS(_uM("flexGrow" to 1, "flexShrink" to 1, "flexBasis" to "0%", "marginTop" to 0, "marginRight" to 5, "marginBottom" to 0, "marginLeft" to 5)), "test-box" to _pS(_uM("width" to "100%", "height" to 80, "backgroundColor" to "#808080")), "demo-box" to _pS(_uM("flexDirection" to "row", "justifyContent" to "space-around", "marginTop" to 10)), "button-container" to _pS(_uM("flexDirection" to "row", "marginTop" to 10, "paddingBottom" to 15, "borderBottomWidth" to 1, "borderBottomStyle" to "solid", "borderBottomColor" to "#d3d3d3")), "button-item" to _pS(_uM("marginRight" to 10)), "@TRANSITION" to _uM("ani" to _uM("property" to "width", "duration" to "2s", "timingFunction" to "linear"), "text-ani" to _uM("property" to "width", "duration" to "2s", "timingFunction" to "ease-in-out"), "image-ani" to _uM("property" to "width,height", "duration" to "2s", "timingFunction" to "ease"), "scroll-view-ani" to _uM("property" to "width", "duration" to "2s", "timingFunction" to "ease-in-out"), "native-view-ani" to _uM("property" to "width", "duration" to "2s", "timingFunction" to "ease-in-out")))
            }
