...
open class GenPagesCSSMarginMarginLeft : BasePage {
    ...
    open var radioChangeMarginLeft: (index: Number) -> Unit
        get() {
            return unref(this.`$exposed`["radioChangeMarginLeft"]) as (index: Number) -> Unit
        }
        set(value) {
            setRefValue(this.`$exposed`, "radioChangeMarginLeft", value)
        }
    ...
    companion object {
        ...
        var setup: (__props: GenPagesCSSMarginMarginLeft, __setupCtx: SetupContext) -> Any? = fun(__props, __setupCtx): Any? {
            val __expose = __setupCtx.expose
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenPagesCSSMarginMarginLeft
            val _cache = __ins.renderCache
            val data = reactive(_uO("marginLeft" to "25px", "marginLeftActual" to "", "marginLeftActualText" to "", "marginLeftActualImage" to "", "marginLeftActualFlat" to "", "marginLeftActualTextFlat" to "", "marginLeftActualImageFlat" to ""))
            ...
            val changeMarginLeft = fun(value: String){
            ...
            val radioChangeMarginLeft = fun(index: Number){
                val selectedItem = marginLeftEnum.find(fun(item): Boolean {
            ...
            val inputChangeMarginLeft = fun(value: String){
            ...
            __expose(_uM("radioChangeMarginLeft" to radioChangeMarginLeft, "data" to data))
            return fun(): Any? {
                    ...
                    _cE("view", _uM("style" to _nS(_uM("flex-grow" to "1"))), _uA(
                        ...
                        _cE("view", null, _uA(
                            ...
                            _cE("view", _uM("class" to "demo-box"), _uA(
                                ...
                                _cE("view", _uM("class" to "demo-container"), _uA(
                                    _cE("view", _uM("class" to "common red")),
                                    _cE("view", _uM("class" to "common", "style" to _nS(_uM("margin-left" to "25px")), "flatten" to ""), null, 4),
                                    _cE("view", _uM("class" to "common blue"))
                                ))
                            ))
                        )),
                        _cE("view", null, _uA(
                            ...
                            _cE("view", _uM("class" to "demo-box"), _uA(
                                ...
                                _cE("view", _uM("class" to "demo-container"), _uA(
                                    _cE("view", _uM("class" to "common red")),
                                    _cE("view", _uM("class" to "common", "style" to _nS(_uM("margin-left" to "10%")), "flatten" to ""), null, 4),
                                    _cE("view", _uM("class" to "common blue"))
                                ))
                            ))
                        )),
                        ...
                        _cE("view", null, _uA(
                            _cE("text", _uM("class" to "uni-subtitle-text"), "margin-left: 10% 和 margin-left: 30px"),
                            _cE("view", _uM("class" to "demo-box"), _uA(
                                _cE("view", _uM("class" to "demo-container"), _uA(
                                    _cE("view", _uM("class" to "common red")),
                                    _cE("scroll-view", _uM("class" to "common", "style" to _nS(_uM("margin-left" to "10%"))), null, 4),
                                    _cE("view", _uM("class" to "common blue"))
                                )),
                                _cE("view", _uM("class" to "demo-container"), _uA(
                                    _cE("view", _uM("class" to "common red")),
                                    _cE("scroll-view", _uM("class" to "common", "style" to _nS(_uM("margin-left" to "30px"))), null, 4),
                                    _cE("view", _uM("class" to "common blue"))
                                ))
                            ))
                        )),
                        _cE("view", _uM("class" to "uni-common-mt"), _uA(
                            _cE("text", _uM("class" to "uni-title-text"), "setProperty 设置与 getPropertyValue 获取 margin-left ")
                        )),
                        _cE("view", _uM("class" to "test-container"), _uA(
                            _cE("view", _uM("class" to "test-item"), _uA(
                                ...
                                _cE("text", _uM("class" to "uni-info"), "设置值: " + _tD(unref(data)["marginLeft"]), 1),
                                _cE("text", _uM("class" to "uni-info"), "获取值: " + _tD(unref(data)["marginLeftActual"]), 1),
                                _cE("view", _uM("class" to "test-box"), _uA(
                                    _cE("view", _uM("class" to "common-view", "style" to _nS(_uM("background-color" to "red"))), null, 4),
                                    _cE("view", _uM("ref_key" to "viewRef", "ref" to viewRef, "class" to "common-view test-view", "style" to _nS(_uM("marginLeft" to unref(data)["marginLeft"]))), _uA(
                            ...
                            _cE("view", _uM("class" to "test-item"), _uA(
                                ...
                                _cE("text", _uM("class" to "uni-info"), "设置值: " + _tD(unref(data)["marginLeft"]), 1),
                                _cE("text", _uM("class" to "uni-info"), "获取值: " + _tD(unref(data)["marginLeftActualText"]), 1),
                                _cE("view", _uM("class" to "test-box"), _uA(
                                    _cE("text", _uM("class" to "common-view common-text", "style" to _nS(_uM("background-color" to "red"))), "红色", 4),
                                    _cE("text", _uM("ref_key" to "textRef", "ref" to textRef, "class" to "common-view common-text test-text", "style" to _nS(_uM("marginLeft" to unref(data)["marginLeft"]))), "text", 4),
                            ...
                            _cE("view", _uM("class" to "test-item"), _uA(
                                ...
                                _cE("text", _uM("class" to "uni-info"), "设置值: " + _tD(unref(data)["marginLeft"]), 1),
                                _cE("text", _uM("class" to "uni-info"), "获取值: " + _tD(unref(data)["marginLeftActualImage"]), 1),
                                _cE("view", _uM("class" to "test-box"), _uA(
                                    _cE("image", _uM("class" to "common-image", "style" to _nS(_uM("background-color" to "red")), "src" to "/static/test-image/logo.png"), null, 4),
                                    _cE("image", _uM("ref_key" to "imageRef", "ref" to imageRef, "class" to "common-image test-image", "style" to _nS(_uM("marginLeft" to unref(data)["marginLeft"])), "src" to "/static/test-image/logo.png"), null, 4),
                        ...
                        _cE("view", _uM("class" to "test-container"), _uA(
                            _cE("view", _uM("class" to "test-item"), _uA(
                                ...
                                _cE("text", _uM("class" to "uni-info"), "设置值: " + _tD(unref(data)["marginLeft"]), 1),
                                _cE("text", _uM("class" to "uni-info"), "获取值: " + _tD(unref(data)["marginLeftActualFlat"]), 1),
                                _cE("view", _uM("class" to "test-box"), _uA(
                                    _cE("view", _uM("class" to "common-view", "style" to _nS(_uM("background-color" to "red"))), null, 4),
                                    _cE("view", _uM("ref_key" to "viewRefFlat", "ref" to viewRefFlat, "class" to "common-view test-view-flatten", "style" to _nS(_uM("marginLeft" to unref(data)["marginLeft"])), "flatten" to ""), _uA(
                                        _cE("text", _uM("class" to "common-text"), "view")
                                    ), 4),
                                    _cE("view", _uM("class" to "common-view", "style" to _nS(_uM("background-color" to "blue"))), null, 4)
                                ))
                            ...
                            _cE("view", _uM("class" to "test-item"), _uA(
                                ...
                                _cE("text", _uM("class" to "uni-info"), "设置值: " + _tD(unref(data)["marginLeft"]), 1),
                                _cE("text", _uM("class" to "uni-info"), "获取值: " + _tD(unref(data)["marginLeftActualTextFlat"]), 1),
                                _cE("view", _uM("class" to "test-box"), _uA(
                                    _cE("text", _uM("class" to "common-view common-text", "style" to _nS(_uM("background-color" to "red"))), "红色", 4),
                                    _cE("text", _uM("ref_key" to "textRefFlat", "ref" to textRefFlat, "class" to "common-view common-text test-text-flatten", "style" to _nS(_uM("marginLeft" to unref(data)["marginLeft"])), "flatten" to ""), "text", 4),
                                    _cE("text", _uM("class" to "common-view common-text", "style" to _nS(_uM("background-color" to "blue"))), "蓝色", 4)
                                ))
                            )),
                            _cE("view", _uM("class" to "test-item"), _uA(
                                ...
                                _cE("text", _uM("class" to "uni-info"), "设置值: " + _tD(unref(data)["marginLeft"]), 1),
                                _cE("text", _uM("class" to "uni-info"), "获取值: " + _tD(unref(data)["marginLeftActualImageFlat"]), 1),
                                _cE("view", _uM("class" to "test-box"), _uA(
                                    _cE("image", _uM("class" to "common-image", "style" to _nS(_uM("background-color" to "red")), "src" to "/static/test-image/logo.png"), null, 4),
                                    _cE("image", _uM("ref_key" to "imageRefFlat", "ref" to imageRefFlat, "class" to "common-image test-image-flatten", "style" to _nS(_uM("marginLeft" to unref(data)["marginLeft"])), "flatten" to "", "src" to "/static/test-image/logo.png"), null, 4),
                                    _cE("image", _uM("class" to "common-image", "style" to _nS(_uM("background-color" to "blue")), "src" to "/static/test-image/logo.png"), null, 4)
                                ))
                            ))
                        )),
                        _cE("view", _uM("class" to "uni-common-mt uni-common-mb"), _uA(
                            ...
                            _cV(_component_enum_data, _uM("items" to marginLeftEnum, "title" to "margin-left 枚举值", "onChange" to radioChangeMarginLeft, "compact" to true)),
                            _cV(_component_input_data, _uM("defaultValue" to unref(data)["marginLeft"], "title" to "margin-left 自定义值", "type" to "text", "onConfirm" to inputChangeMarginLeft), null, 8, _uA(
                                "defaultValue"
                            ))
                        )),
                        _cE("view", _uM("class" to "uni-common-mb"), _uA(
                            _cE("text", null, "native-view组件: margin-left: 25px 和 10%"),
                            _cE("view", _uM("class" to "demo-box"), _uA(
                                _cE("view", _uM("class" to "demo-container"), _uA(
                                    _cE("view", _uM("class" to "common red")),
                                    _cE("native-view", _uM("class" to "common", "style" to _nS(_uM("margin-left" to "25px"))), null, 4),
                                    _cE("view", _uM("class" to "common blue"))
                                )),
                                _cE("view", _uM("class" to "demo-container"), _uA(
                                    _cE("view", _uM("class" to "common red")),
                                    _cE("native-view", _uM("class" to "common", "style" to _nS(_uM("margin-left" to "10%"))), null, 4),
                                    _cE("view", _uM("class" to "common blue"))
                                ))
                            ))
                        ))
